(function (exports) {
	...
	var color = createColors(exports.arrayLength);
	function quickSortIterative(_x) {
	  return _quickSortIterative.apply(this, arguments);
	}

	function _quickSortIterative() {
	  _quickSortIterative = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(arr) {
	    var stack, end, start, pivotIndex;
	...
	function partition(_x2, _x3, _x4) {
	  return _partition.apply(this, arguments);
	}

	function _partition() {
	  _partition = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(arr, start, end) {
	    var i, pivotValue, pivotIndex, _i, _ref, _ref2, _i2;
	    ...
	    return regeneratorRuntime.wrap(function _callee2$(_context2) {
	      while (1) {
	        switch (_context2.prev = _context2.next) {
	          ...
	          case 9:
	            draw(arr, color); // Swapping elements

	            _ref = [arr[pivotIndex], arr[_i]];
	            arr[_i] = _ref[0];
	          ...
	          case 19:
	            ...
	            if (end - start < 4) {
	              for (_i2 = start; _i2 < arr.length; _i2++) {
	                color[_i2] = 'green';
	              }
	            ...
	            return _context2.abrupt("return", pivotIndex);
	...
	var quickBtn = document.querySelector('#quickBtn');
	var height = window.innerHeight / 100;
	sliderValue.textContent = slider.value; // slider event
	...
	function draw(array, color) {
	  ...
	  for (var i = 0; i < exports.arrayLength; i++) {
	    if (color[i] === 'green') {
	      var barEl = el('div');
